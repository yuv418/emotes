...
IMPORTANT: You'll need an admin API key for most of the actions regarding users. Not all of them, but most. I'll poin out when you'll need an admin API key here.
